        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              {imagePreview ? (
                <img src={getImageSrc(imagePreview)} alt="Service preview" className="w-full max-h-64 object-cover rounded-lg border" />
              ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-gray-50 rounded-lg p-3 text-sm text-gray-600 flex items-center">Duration is used for booking time-slot availability.</div>
          </div>
