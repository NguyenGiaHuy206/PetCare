    ...
    switch (status) {
      case 'success':
        return {
          ...
          message: source === "booking" ? "Your booking has been created." : "Your order has been confirmed and will be processed shortly.",
          orderId,
        };
      case 'pending':
        return {
        ...
        <div className="bg-white rounded-lg border p-8 text-center">
          ...
          <div className="space-y-3">
            {status === 'success' && config.orderId && (
              <Link
                to={source === "booking" ? "/bookings" : "/orders"}
              ...
              >
                ...
                {source === "booking" ? "View Bookings" : "View Orders"}
              </Link>
            )}
