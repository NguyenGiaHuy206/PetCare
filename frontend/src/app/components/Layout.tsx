          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li><Link to="/shop?category=food" className="hover:text-gray-900">Food & Treats</Link></li>
                <li><Link to="/shop?category=toys" className="hover:text-gray-900">Toys</Link></li>
                <li><Link to="/shop?category=accessories" className="hover:text-gray-900">Accessories</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">Services</h3>
              <ul className="space-y-2 text-sm text-gray-600">
                <li><Link to="/services" className="hover:text-gray-900">Grooming</Link></li>
                <li><Link to="/services" className="hover:text-gray-900">Veterinary</Link></li>
                <li><Link to="/services" className="hover:text-gray-900">Training</Link></li>
                <li><Link to="/services" className="hover:text-gray-900">Daycare</Link></li>
              </ul>
            </div>
            <div>
